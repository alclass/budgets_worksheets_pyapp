#!/usr/bin/env python3
"""
art/bcb_br/fetch/prettyprint/batch_exchrate_fetcher_w_dispatcher.py
...
import lib.indices.bcb_br.bcb_cotacao_fetcher_from_db_or_api as bcbf  # bcbfetch.BCBCotacaoFetcher
