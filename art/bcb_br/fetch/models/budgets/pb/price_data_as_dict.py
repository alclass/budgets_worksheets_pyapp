...
import copy
import os
from art.bcb_br.fetch.models.budgets.pb.prices_processor import PriceItem
from art.bcb_br.fetch.models.budgets.pb.prices_processor import Prices
from art.bcb_br.fetch.models.budgets.pb.prices_processor import show_qtd_of_prices_per_nm
import art.bcb_br.fetch.models.budgets.pb.tests.check_n_of_nms_in_filenames as chknm  # chknm.get_unique_nms_from_filenames
...
def gather_data():
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-27'
  pi.opengrossprice, pi.supplier = 72.59, 'Mercado Livre / Comunicação10'
  ...
  pi = copy.copy(pi_tmp)
  pi.date = '2024-02-27'
  pi.opengrossprice, pi.supplier = 69.0, 'Tolentino Radiocomunicação'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-24'
  pi.opengrossprice, pi.supplier = 128.6, 'Ponto Eletrônico'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-24'
  pi.opengrossprice, pi.supplier = 168.8, 'Ponto Eletrônico'
  pi.url = 'https://www.pontoeletronicolojavirtual.com.br/produtos/conjunto-de-aterramento-para-cabo-de-rg-213-rfs-kmp/'
  prices.add_price_via_nm(pi.nmcode, pi)
  pi = copy.copy(pi_tmp)
  pi.date = '2024-02-24'
  pi.opengrossprice, pi.supplier = 70.2, 'Cross do Brasil'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-24'
  pi.opengrossprice, pi.supplier = 42.0, 'Cross do Brasil'
  pi.url = 'https://www.crossdobrasil.com.br/kit-aterramentos/kit-aterramento-rgc213-'
  prices.add_price_via_nm(pi.nmcode, pi)
  pi = copy.copy(pi_tmp)
  pi.date = '2024-02-24'
  pi.opengrossprice, pi.supplier = 148.60, 'Ponto Eletrônico'
  pi.url = 'https://www.pontoeletronicolojavirtual.com.br/produtos/conjunto-de-aterramento-para-cabo-de-rg-213-rfs-kmp/'
  prices.add_price_via_nm(pi.nmcode, pi)
  pi = copy.copy(pi_tmp)
  pi.date = '2024-02-24'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-24'
  pi.opengrossprice, pi.supplier = 127.55, 'Mercado Livre / Store Comércio'
  pi.url = 'https://produto.mercadolivre.com.br/MLB-1791043867-protetor-dps-contra-raios-e-surtos-cabo-coaxial-_JM'
  prices.add_price_via_nm(pi.nmcode, pi)
  pi = copy.copy(pi_tmp)
  pi.date = '2024-02-24'
  pi.opengrossprice, pi.supplier = 85.9, 'Oficina dos Bits'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-27'
  pi.opengrossprice, pi.supplier = 36.8, 'Ponto Eletrônico'
  pi.url = 'https://www.pontoeletronicolojavirtual.com.br/produtos/adaptador-n-macho-x-femea-tnc-klc-klc-19/'
  prices.add_price_via_nm(pi.nmcode, pi)
  pi = copy.copy(pi_tmp)
  pi.date = '2024-02-27'
  pi.opengrossprice, pi.supplier = 32.6, 'Mercado Livre / STM Telecom'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-27'
  pi.opengrossprice, pi.supplier = 20.0, 'MultComercial'
  pi.url = 'https://www.multcomercial.com.br/adaptador-uhf-femea-x-femea-reto-ka-1-gav-97-klc.html'
  prices.add_price_via_nm(pi.nmcode, pi)
  pi = copy.copy(pi_tmp)
  pi.date = '2024-02-27'
  pi.opengrossprice, pi.supplier = 16.9, 'Rádio Componentes'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-27'
  pi.opengrossprice, pi.supplier = 22.0, 'Rádio Componentes'
  pi.url = 'https://www.radiocomponentes.com.br/adaptador-bnc-femea-x-n-macho-p585'
  prices.add_price_via_nm(pi.nmcode, pi)
  pi = copy.copy(pi_tmp)
  pi.date = '2024-02-27'
  pi.opengrossprice, pi.supplier = 19.01, 'Shop Antena'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-27'
  pi.opengrossprice, pi.supplier = 21.0, 'Rádio Componentes'
  pi.url = 'https://www.radiocomponentes.com.br/adaptador-n-emenda-reto-2-femea-p532'
  prices.add_price_via_nm(pi.nmcode, pi)
  pi = copy.copy(pi_tmp)
  pi.date = '2024-02-27'
  pi.opengrossprice, pi.supplier = 27.21, 'Magalu / MultComercial'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-27'
  pi.opengrossprice, pi.supplier = 19.57, 'Magalu / Shop Antena'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-27'
  pi.opengrossprice, pi.supplier = 28.0, 'Rádio Componentes'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-27'
  pi.opengrossprice, pi.supplier = 29.0, 'Rádio Componentes'
  pi.url = 'https://www.shopantenas.com.br/conectores/adaptadores/conversao-entre-series/adaptador-de-conversao-reto-n-50-ohms-macho-x-uhf-femea-klc-5'
  prices.add_price_via_nm(pi.nmcode, pi)
  pi = copy.copy(pi_tmp)
  pi.date = '2023-05-01'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-27'
  pi.opengrossprice, pi.supplier = 34.9, 'Shop Antena'
  pi.url = 'https://www.shopantenas.com.br/conectores/adaptadores/conversao-entre-series/adaptador-de-conversao-reto-n-50-ohms-macho-x-uhf-femea-klc-5'
  prices.add_price_via_nm(pi.nmcode, pi)
  pi = copy.copy(pi_tmp)
  pi.date = '2024-02-27'
  pi.opengrossprice, pi.supplier = 27.7, 'Shopee Sckytecc Telecom'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-27'
  pi.opengrossprice, pi.supplier = 17.8, 'Fazolo Componentes'
  pi.url = 'https://fazolo.com.br/componentes-eletronicos/adaptador-uhf-machouhf-femea-reto-ka-8'
  prices.add_price_via_nm(pi.nmcode, pi)
  pi = copy.copy(pi_tmp)
  pi.date = '2024-02-27'
  pi.opengrossprice, pi.supplier = 19.95, 'Shopee / Rádio Componentes'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-25'
  pi.opengrossprice, pi.supplier = 39.9, 'Shop Web'
  pi.url = 'https://shopweb.com.br/produto/cabo-cellflex-1-2-hansen-100-metros/'
  prices.add_price_via_nm(pi.nmcode, pi)
  pi = copy.copy(pi_tmp)
  pi.date = '2024-02-25'
  pi.opengrossprice, pi.supplier = 58.67, 'Magalu / Bit Electronics'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-25'
  pi.opengrossprice, pi.supplier = 9.49, 'Village Home Center BR'
  pi.url = 'https://www.villagehomecenter.com.br/conector-femea-de-rosca-rg59-para-cabo-coaxial-com-4-pecas-tblack/p'
  prices.add_price_via_nm(pi.nmcode, pi)
  pi = copy.copy(pi_tmp)
  pi.date = '2024-02-25'
  pi.opengrossprice, pi.supplier = 5.0, 'Comercial EletronSP'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-25'
  pi.opengrossprice, pi.supplier = 5.7, 'Solução Cabos'
  pi.url = 'https://www.solucaocabos.com.br/conector-bnc-macho-rg59-compressao-pino-fixo/p'
  prices.add_price_via_nm(pi.nmcode, pi)
  pi = copy.copy(pi_tmp)
  pi.date = '2024-02-25'
  pi.opengrossprice, pi.supplier = 5.09, 'Loja Elétrica'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-25'
  pi.opengrossprice, pi.supplier = 11.0, 'Cross do Brasil'
  pi.url = 'https://www.crossdobrasil.com.br/conectores/conector-iec-femea-reto-0-6x3-7-solda'
  prices.add_price_via_nm(pi.nmcode, pi)
  pi = copy.copy(pi_tmp)
  pi.date = '2024-02-27'
  pi.opengrossprice, pi.supplier = 15.05, 'Magalu / Mult E-commerce'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-25'
  pi.opengrossprice, pi.supplier = 12.35, 'Rádio Componentes'
  pi.url = 'https://www.radiocomponentes.com.br/mc145436ap-mc145lc436p-freq-receiver-p858'
  prices.add_price_via_nm(pi.nmcode, pi)
  pi = copy.copy(pi_tmp)
  pi.date = '2024-02-25'
  pi.opengrossprice, pi.supplier = 17.9, 'Shop Antenas'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-25'
  pi.opengrossprice, pi.supplier = 33.34, 'Central Cabos'
  pi.url = 'https://www.centralcabos.com.br/conector-n-femea-rgc-58/p'
  prices.add_price_via_nm(pi.nmcode, pi)
  pi = copy.copy(pi_tmp)
  pi.date = '2024-02-25'
  pi.opengrossprice, pi.supplier = 25.0, 'Rádio Componentes'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-25'
  pi.opengrossprice, pi.supplier = 33.34, 'Village Home Center BR'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-25'
  pi.opengrossprice, pi.supplier = 15.9, 'Cross do Brasil'
  pi.url = 'https://www.crossdobrasil.com.br/conectores/conector-n-femea-reto-rgc213'
  prices.add_price_via_nm(pi.nmcode, pi)
  pi = copy.copy(pi_tmp)
  pi.date = '2024-02-27'
  pi.opengrossprice, pi.supplier = 39.8, 'Mercado Livre / Tolentino1'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-27'
  pi.opengrossprice, pi.supplier = 42.59, 'Bit Electronics'
  pi.url = 'https://www.bitelectronics.com.br/telecomunicacao/conectores/conector-n-femea-p-cabo-cellflex-12-k'
  prices.add_price_via_nm(pi.nmcode, pi)
  pi = copy.copy(pi_tmp)
  pi.date = '2024-02-27'
  pi.opengrossprice, pi.supplier = 59.40, 'Mercado Livre / STM Telecom'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-27'
  pi.opengrossprice, pi.supplier = 76.21, 'Magalu / Bit Electronics'
  pi.url = 'https://www.magazineluiza.com.br/conector-n-femea-p-cabo-cellflex-7-8-k-klc/p/dkhc4gca9k/te/ppcl/'
  prices.add_price_via_nm(pi.nmcode, pi)
  pi = copy.copy(pi_tmp)
  pi.date = '2024-02-27'
  pi.opengrossprice, pi.supplier = 68.33, 'Bit Electronics'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-27'
  pi.opengrossprice, pi.supplier = 19.0, 'Rádio Componentes'
  pi.url = 'https://www.radiocomponentes.com.br/conector-n-femea-reto-prensa-rg58-cf-3e-p1082'
  prices.add_price_via_nm(pi.nmcode, pi)
  pi = copy.copy(pi_tmp)
  pi.date = '2024-02-27'
  pi.opengrossprice, pi.supplier = 17.9, 'Oficina dos Bits'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-27'
  pi.opengrossprice, pi.supplier = 15.0, 'Loja Integrada / Só Conectores'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-27'
  pi.opengrossprice, pi.supplier = 16.9, 'Shopee / VP Telecom'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-27'
  pi.opengrossprice, pi.supplier = 26.9, 'Aquário'
  pi.url = 'https://loja.aquario.com.br/conector-plug-n-macho-para-cabo-rgc213/p'
  prices.add_price_via_nm(pi.nmcode, pi)
  pi = copy.copy(pi_tmp)
  pi.date = '2024-02-27'
  pi.opengrossprice, pi.supplier = 33.5, 'Net Computadores'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-27'
  pi.opengrossprice, pi.supplier = 49.05, 'Shopee / STM Telecom'
  pi.url = 'https://shopee.com.br/Conector-Cellflex-N-50-Ohms-Macho-1-2%27%27-Flex%C3%ADvel-Cm-23-i.1060572709.23696917485'
  prices.add_price_via_nm(pi.nmcode, pi)
  pi = copy.copy(pi_tmp)
  pi.date = '2024-02-27'
  pi.opengrossprice, pi.supplier = 55.65, 'Mercado Livre / STM Telecom'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-27'
  pi.opengrossprice, pi.supplier = 185.0, 'Broadcast Shop BR'
  pi.url = 'https://www.broadcastshop.com.br/produtos/conector-cabo-7-8-n-macho-rfs-kmp-nm-lcf78-c02/'
  prices.add_price_via_nm(pi.nmcode, pi)
  pi = copy.copy(pi_tmp)
  pi.date = '2024-02-27'
  pi.opengrossprice, pi.supplier = 186.0, 'Ponto Eletrônico'
  ...
  pi = copy.copy(pi_tmp)
  pi.date = '2024-02-27'
  pi.opengrossprice, pi.supplier = 13.54, 'Central Cabos'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-27'
  pi.opengrossprice, pi.supplier = 27.9, 'Ecotron Componentes'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-27'
  pi.opengrossprice, pi.supplier = 396.13, 'VH Telecom'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-26'
  pi.opengrossprice, pi.supplier = 80.83, 'Amazon / Daji-Direct'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-25'
  pi.opengrossprice, pi.supplier = 26.0, 'Rádio Componentes'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-25'
  pi.opengrossprice, pi.supplier = 28.0, 'KLP Conectores'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-26'
  pi.opengrossprice, pi.supplier = 27.0, 'DataComm BR'
  pi.url = 'https://www.datacomm.com.br/cabo-cellflex-rf-1-2-scf12-50j-lance-50m-c-conector-uhf/'
  prices.add_price_via_nm(pi.nmcode, pi)
  pi = copy.copy(pi_tmp)
  pi.date = '2024-02-26'
  pi.opengrossprice, pi.supplier = 40.3, 'Mercado Livre / BrComm'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-26'
  pi.opengrossprice, pi.supplier = 28.9, 'KLP Conectores'
  pi.url = 'https://www.casadosconectores.com.br/product/conector-uhf-macho-crimpe-rgc-213/'
  prices.add_price_via_nm(pi.nmcode, pi)
  pi = copy.copy(pi_tmp)
  pi.date = '2024-02-26'
  pi.opengrossprice, pi.supplier = 34.0, 'Shop Antenas'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-26'
  pi.opengrossprice, pi.supplier = 32.9, 'MultComercial'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-26'
  pi.opengrossprice, pi.supplier = 27.0, 'Shop Antenas'
  pi.url = 'https://www.shopantenas.com.br/conector-uhf-macho-solda-rg58-steelbras-ap0018'
  prices.add_price_via_nm(pi.nmcode, pi)
  pi = copy.copy(pi_tmp)
  pi.date = '2024-02-26'
  pi.opengrossprice, pi.supplier = 26.5, 'Fozolo Componentes'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-26'
  pi.opengrossprice, pi.supplier = 12.0, 'Casa dos Conectores'
  pi.url = 'https://www.casadosconectores.com.br/product/conector-f-macho-rg-11-crimpe/'
  prices.add_price_via_nm(pi.nmcode, pi)
  pi = copy.copy(pi_tmp)
  pi.date = '2024-02-25'
  pi.opengrossprice, pi.supplier = 40.0, 'Trekking Tecnologia'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-25'
  pi.opengrossprice, pi.supplier = 303.18, 'Mercado Livre / 48.900.etc'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-25'
  pi.opengrossprice, pi.supplier = 275.0, 'Bit Electronics BR'
  ...
  pi = copy.copy(pi_tmp)
  pi.date = '2024-02-25'
  pi.opengrossprice, pi.supplier = 950.0, 'Mercado Livre / Cabo Eletro'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-25'
  pi.opengrossprice, pi.supplier = 267.88, 'Mercado Livre / Fenganshopbr'
  ...
  pi = copy.copy(pi_tmp)
  pi.date = '2021-11-03'
  pi.opengrossprice, pi.supplier = 72.60, 'Americanas / Soubarato'
  pi.url = 'https://www.americanas.com.br/produto/2378488197'
  prices.add_price_via_nm(pi.nmcode, pi)
  pi = copy.copy(pi_tmp)
  pi.date = '2021-11-03'
  pi.opengrossprice, pi.supplier = 71.81, 'Soubarato'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-25'
  pi.opengrossprice, pi.supplier = 267.88, 'Ponto Eletrônico'
  pi.url = 'https://www.pontoeletronicolojavirtual.com.br/produtos/adaptador-uhf-femea-x-femea-n-klc-klc-55/'
  prices.add_price_via_nm(pi.nmcode, pi)
  pi = copy.copy(pi_tmp)
  pi.date = '2024-02-25'
  pi.opengrossprice, pi.supplier = 26.25, 'Mercado Livre / STM Telecom'
  ...
  pi = copy.copy(pi_tmp)
  pi.date = '2024-02-26'
  pi.opengrossprice, pi.supplier = 32.0, 'Ponto Eletrônico'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-25'
  pi.opengrossprice, pi.supplier = 5504.00, 'Mouser Electronics (Europa)'
  pi.url = 'https://br.mouser.com/ProductDetail/HUBER%2BSUHNER/5930_N-50-050-19-_NE'
  prices.add_price_via_nm(pi.nmcode, pi)
  pi = copy.copy(pi_tmp)
  pi.date = '2024-02-26'
  pi.opengrossprice, pi.supplier = 5717.27, 'Distrelec (Europa)'
  ...
  pi.meas_unit = 'metro'
  pi.date = '2024-02-26'
  pi.opengrossprice, pi.supplier = 2.92, 'Portal Elétrico'
  ...
  pi = copy.copy(pi_tmp)
  pi.date = '2024-02-26'
  pi.opengrossprice, pi.supplier = 2.6, 'Mercado Livre / GGMaxCondutores'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-26'
  pi.opengrossprice, pi.supplier = 18.95, 'MultComercial'
  ...
  pi = copy.copy(pi_tmp)
  pi.date = '2024-02-26'
  pi.opengrossprice, pi.supplier = 13.8, 'Mercado Livre / Info Connect'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-26'
  pi.opengrossprice, pi.supplier = 18.47, 'Elecbee (Internacional)'
  pi.url = 'https://www.elecbee.com/pt-480-n-type-connector-lmr-600-straight-plug-for-cable'
  prices.add_price_via_nm(pi.nmcode, pi)
  pi = copy.copy(pi_tmp)
  pi.date = '2024-02-26'
  pi.opengrossprice, pi.supplier = 40.8, 'Casa dos Conectores'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-26'
  pi.opengrossprice, pi.supplier = 8.19, 'Mercado Livre / EletroInffoCiaGold'
  pi.url = 'https://produto.mercadolivre.com.br/MLB-904436340-conector-f-rgc59-de-rosca-p-cabo-c-friso-55mm-_JM'
  prices.add_price_via_nm(pi.nmcode, pi)
  pi = copy.copy(pi_tmp)
  pi.date = '2024-02-26'
  pi.opengrossprice, pi.supplier = 4.49, 'Eletro Peças'
  ...
  pi_tmp = copy.copy(pi)
  pi.date = '2024-02-26'
  pi.opengrossprice, pi.supplier = 26.9, 'Rádio Componentes'
  pi.url = 'https://www.radiocomponentes.com.br/adaptador-uhf-f-base-quadrada-4-furos-rosca-p588'
  prices.add_price_via_nm(pi.nmcode, pi)
  pi = copy.copy(pi_tmp)
  pi.date = '2024-02-26'
  pi.opengrossprice, pi.supplier = 39.0, 'Mercado Livre / Rádio Componentes'
