#!/usr/bin/env python3
"""
commands/show/monecorr_n_indices_from_dates_calculator.py
...
Usage:
  $monecorr_n_indices_from_dates_calculator.py <text-file-with-dates>
...
Example:
  $monecorr_n_indices_from_dates_calculator.py datafile.dat
In datafile.dat:
2020-10-15
2021-07-01
2022-03-03
...
import lib.indices.bcb_br.bcb_cotacao_fetcher_from_db_or_api as bcbfetch  # bcbfetch.BCBCotacaoFetcher
import lib.datefs.introspect_dates as idt  # idt.for make_date_or_none()
import lib.datefs.refmonths_mod as rfm  # rfm.calc_refmonth_minus_n()
import lib.datefs.read_write_datelist_files_fs as rwdt
