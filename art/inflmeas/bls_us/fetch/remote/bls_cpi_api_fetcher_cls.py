#!/usr/bin/env python3
"""
commands/fetch/bls_us/bls_cpi_api_fetcher_cls.py
...
import art.inflmeas.bls_us.fetch.remote.cpi_rest_api_fetcher_fs as ftchfs  # .fetch_json_response_w_restapi_reqdictdata
