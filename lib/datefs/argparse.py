...
import argparse
import datetime
import lib.datefs.dategenerators as hilodt
...
import lib.datefs.read_write_datelist_files_fs as rwdt  # .fetch_dates_from_textfile_w_filepath
  ...
  def dispatch(self):
    ...
    if self.args.refmonthdate:
      ...
      if refmonthdate is None:
        ...
        return 0
      self.datelist = hilodt.gen_dailydates_for_refmonth_or_empty_opt_order_coff_accfut(refmonthdate)
      return self.apply()
    if self.args.date:
