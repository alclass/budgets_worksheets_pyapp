...
"""
lib/db/db_pool.py
  Contains DB functionality including:
  - Full support for both datetime.date and datetime.datetime
  - Automatic retry with logging for visibility
  - Clean resource handling via context manager
