...
class TestCaseTableauLetterIndexGenerator(unittest.TestCase):
  ...
  def ztest_comparing_the_80_first_gen_indices(self):
    ...
    total_to_gen = 80
    letterindices = list(self.idxgen.gen_first_n_letterindices(total_to_gen))
  ...
  def ztest_range_generation(self):
    ...
    for lindices in self.idxgen.gen_letterindices_within_range_as_0basedidx(start=3, end=7, decrescent=False):
    ...
    return_gen_list = []
    counted = 0
    for lindices in self.idxgen.gen_letterindices_within_range_as_0basedidx(start=3, end=7, decrescent=True):
      return_gen_list.append(lindices)
      counted += 1
